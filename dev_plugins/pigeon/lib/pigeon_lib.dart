...
class DartGeneratorAdapter implements GeneratorAdapter {
  ...
  void generate(
      StringSink sink, PigeonOptions options, Root root, FileType fileType) {
    final dartOptions = options.dartOptions ?? DartOptions();
    final DartOptions dartOptionsWithHeader = dartOptions.merge(
      DartOptions(
